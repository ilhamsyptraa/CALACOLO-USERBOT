...
async def reedme(e):
    await e.edit(
        ...
        "\n[RAM-UBOT Repo](https://github.com/ilhamsyptraa/CALACOLO-USERBOT/blob/RAM-UBOT/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        f"**╭✠╼━━━━━━❖━━━━━━━✠╮**\n[{REPO_NAME}](https://github.com/ilhamsyptraa/CALACOLO-USERBOT)\n╰✠╼━━━━━━❖━━━━━━━✠╯\n•PEMILIK         : [𝐎𝐖𝐍𝐄𝐑]({OWNER_BOT})\n•CHANNEL      : [𝐈𝐍𝐅𝐎](https://t.me/fucekheart)\n•GROUP           : [𝐆𝐑𝐎𝐔𝐏]({GROUP_LINK})\n•INSTAGRAM  :  [𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌]({IG_ALIVE})"
    )
