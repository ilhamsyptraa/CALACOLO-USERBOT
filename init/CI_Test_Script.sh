...
tg_sendinfo "<code>I am gonna merge staging into CALACOLO-USERBOT</code>"
cd
...
tg_sendinfo "<code>I have merged all commits from staging into CALACOLO-USERBOT</code>"
